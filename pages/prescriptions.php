...
<body>
  ...
  <div class="container" style="margin: 0px 80px 0px 50px;">
    ...
    <h1 class=".navbar-brand text-warning" style="position: absolute; text-align:center; left: 0; right:0;">Prescriptions</h1>	
    <div class="user" >
...
<h6><?php echo $adminData['email']; ?></h6>
	...
	<section id="sections" class="py-4 mb-2">
        ...
        <div class="col-md-3">
					<a href="?add" class="btn btn-danger btn-block" id="add" data-bs-toggle="modal" data-bs-target="#addPrescription"><i class='bx bx-plus-medical'></i>Add Prescription</a>
				</div>
				<div class="col-md"></div>
			</div>
		</div>
	...
	<section id="post">
		<div class="container" style="padding:0px 50px 0px 50px; min-width:100%">
			<div class="row">
			<table id="tblprescription" class="table table-hover table-striped">
							<thead>
								<th>Medicine Code</th>
                ...
                <th>Action</th>
                 ...
                 <tr>
                   ...
                   <a class="btn btn-success btn-sm" data-bs-toggle="modal" id="editbtn" data-bs-target="#edit"
                                        ...
                                        data-coid="<?php echo $ConsultationID; ?>"
                                        data-quan="<?php echo $Quantity; ?>"
               										    	data-dos="<?php echo $Dosage; ?>">
                                        <i class="fas fa-edit"></i>
                      </a>
                      <a class="btn btn-danger btn-sm" href="../php/pres-module.php?delete=<?php echo $MedCode; ?>&consultationID=<?php echo $ConsultationID; ?>&dosage=<?php echo $Dosage; ?>&quantity=<?php echo $Quantity; ?>" onclick="return confirm('Are you sure you want to delete the account?')";><i class='bx bx-trash'></i></a>
                   </td>
                 </tr>
                 <?php
                 }
			...
			<div class="modal-content">
				<div class="modal-header bg-danger text-white">
					<div class="modal-title">
						<h5>Adď Prescription</h5>
					</div>
					<button type="button btn" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<form action="../php/pres-module.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label class="form-control-label">Medicine Code:</label>
							<input type="number" name="_medcode" class="form-control" required autocomplete="off"> <br>
              
              <label class="form-control-label">Consultation ID:</label>
              <input type="number" name="_consultationID" class="form-control" required autocomplete="off"> <br>

              <label class="form-control-label">Quantity:</label>
              <input type="number" name="_quantity" class="form-control" required autocomplete="off"> <br>

              <label class="form-control-label">Dosage:</label>
              <input type="text" name="_dosage" class="form-control" required autocomplete="off"> <br> 
						</div>
						<br>
				</div>
  ...
  <div class="modal fade" id="edit">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form action="../php/pres-module.php" method="GET" enctype="multipart/form-data">
          ...
          <div class="row mx-3">
            ...
            <div class="col-sm">
              <input type="number" id="consid" name="consid" value="" readonly style="border:none;">
            </div>
          <hr>
          </div>
            <div class="row mx-3">
            ...
            <div class="col-sm">
              <input type="number" id="medicode" name="medicode" value="">
            </div>
          <hr>
          </div>
          <div class="row mx-3">
            ...
            <div class="col-sm">
              <input type="number" id="mediquan" name="mediquan" value="">
            </div>
          <hr>
          </div>
          <div class="row mx-3">
          ...
          <div class="col-sm">
          <input type="text" id="medidosage" name="medidosage" value="">
          </div>
          <hr>
          </div>      
          </div>
